...
import (
	...
	"github.com/TheNoobiCat/go-libp2p/p2p/net/nat/internal/nat"
	"github.com/stretchr/testify/require"
	"go.uber.org/mock/gomock"
)

//go:generate sh -c "go run go.uber.org/mock/mockgen -package nat -destination mock_nat_test.go github.com/TheNoobiCat/go-libp2p/p2p/net/nat/internal/nat NAT"
